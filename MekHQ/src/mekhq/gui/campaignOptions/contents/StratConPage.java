...
class StratConPage {
    ...
    @Nonnull JPanel createPanel(@Nullable RulesetsOptionsModel model) {
        ...
        chkUseStaticOpForRoster.addMouseListener(createTipPanelUpdater("UseStaticOpForRoster"));
        chkUseStaticOpForMilitia = new CampaignOptionsCheckBox("UseStaticOpForMilitia");
        chkUseStaticOpForMilitia.addMouseListener(createTipPanelUpdater("UseStaticOpForMilitia"));
        lblStaticOpForPaddingFactor = new CampaignOptionsLabel("StaticOpForPaddingFactor");
        lblStaticOpForPaddingFactor.addMouseListener(createTipPanelUpdater("StaticOpForPaddingFactor"));
        spnStaticOpForPaddingFactor = new CampaignOptionsSpinner("StaticOpForPaddingFactor", 1.25, 0.5, 5.0, 0.05);
        spnStaticOpForPaddingFactor.addMouseListener(createTipPanelUpdater("StaticOpForPaddingFactor"));
        lblStaticOpForFormationCountFloor = new CampaignOptionsLabel("StaticOpForFormationCountFloor");
        lblStaticOpForFormationCountFloor.addMouseListener(createTipPanelUpdater("StaticOpForFormationCountFloor"));
        spnStaticOpForFormationCountFloor = new CampaignOptionsSpinner("StaticOpForFormationCountFloor", 3, 1, 20, 1);
        spnStaticOpForFormationCountFloor.addMouseListener(createTipPanelUpdater("StaticOpForFormationCountFloor"));
    ...
    private @Nonnull JPanel createStratConScenarioGenerationPanel() {
        ...
        panel.addCheckBoxGrid(CHECKBOX_GRID_COLUMNS,
                ...
                chkUseStaticOpForRoster,
                chkUseStaticOpForMilitia);
        ...
        panel.addRow(lblStaticOpForPaddingFactor, spnStaticOpForPaddingFactor);
        panel.addRow(lblStaticOpForFormationCountFloor, spnStaticOpForFormationCountFloor);
    ...
    void readFromModel(@Nullable RulesetsOptionsModel model) {
        ...
        chkUseStaticOpForRoster.setSelected(model.useStaticOpForRoster);
        chkUseStaticOpForMilitia.setSelected(model.useStaticOpForMilitia);
        spnStaticOpForPaddingFactor.setValue(model.staticOpForPaddingFactor);
        spnStaticOpForFormationCountFloor.setValue(model.staticOpForFormationCountFloor);
    }
    ...
    void writeToModel(@Nullable RulesetsOptionsModel model) {
        ...
        model.useStaticOpForRoster = chkUseStaticOpForRoster.isSelected();
        model.useStaticOpForMilitia = chkUseStaticOpForMilitia.isSelected();
        model.staticOpForPaddingFactor = (double) spnStaticOpForPaddingFactor.getValue();
        model.staticOpForFormationCountFloor = (int) spnStaticOpForFormationCountFloor.getValue();
    }
}
