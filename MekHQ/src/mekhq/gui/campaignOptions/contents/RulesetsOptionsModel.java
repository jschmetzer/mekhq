...
class RulesetsOptionsModel {
    ...
    boolean useStaticOpForRoster;
    boolean useStaticOpForMilitia;
    double staticOpForPaddingFactor;
    int staticOpForFormationCountFloor;
    ...
    RulesetsOptionsModel(@Nonnull CampaignOptions options) {
        ...
        useStaticOpForRoster = options.isUseStaticOpForRoster();
        useStaticOpForMilitia = options.isUseStaticOpForMilitia();
        staticOpForPaddingFactor = options.getStaticOpForPaddingFactor();
        staticOpForFormationCountFloor = options.getStaticOpForFormationCountFloor();
    }
    ...
    void applyTo(@Nonnull CampaignOptions options) {
        ...
        options.setUseStaticOpForRoster(useStaticOpForRoster);
        options.setUseStaticOpForMilitia(useStaticOpForMilitia);
        options.setStaticOpForPaddingFactor(staticOpForPaddingFactor);
        options.setStaticOpForFormationCountFloor(staticOpForFormationCountFloor);
    }
}
