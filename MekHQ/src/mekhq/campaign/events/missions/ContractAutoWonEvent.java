...
/**
 * Triggered when a contract is won automatically during scenario resolution — e.g. the
 * static OpFor roster has been fully eliminated. The GUI listens for this so it can run
 * the full end-of-contract completion flow (payment, loyalty/turnover roll, AutoAwards,
 * faction standings, follow-up offer) rather than only finalizing payment.
 */
