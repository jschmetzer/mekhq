...
/**
 * MekHQ event fired after the static OpFor roster is updated by a scenario resolution.
 *
 * <p>Subscribers (e.g. {@code OpForRosterPanel}) can listen for this event to refresh
 * their display without polling.</p>
 */
